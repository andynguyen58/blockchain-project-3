App = {
  ...
  sku: 0,
  upc: 0,
  metamaskAccountID: "0x601F7C433e1B33fDC429338300F98B8d27bf2829",
  ownerID: "0x601F7C433e1B33fDC429338300F98B8d27bf2829",
  originFarmerID: "0xB16747D3B1531D1430D0C5fbF32Ceac164b39e01",
  distributorID: "0xBB75c601305275F8371B1398FAaeF6f1e104E552",
  retailerID: "0x10B27C30158cF8F0277b95F0fB1df28fE9040ff2",
  consumerID: "0x2075b12191Bb455a029f8476564FEa3f5d645C7e",
  originFarmName: null,
  ...
  reset: function (event) {
    ...
    App.contracts.SupplyChain.deployed()
      .then(function (instance) {
        return instance.reset(App.upc, { from: App.metamaskAccountID });
      })
  ...
  sellItem: function (event) {
    ...
    App.contracts.SupplyChain.deployed()
      .then(function (instance) {
        ...
        return instance.sellItem(App.upc, App.productPrice, App.distributorID, {
  ...
  shipItem: function (event) {
    ...
    App.contracts.SupplyChain.deployed()
      .then(function (instance) {
        return instance.shipItem(App.upc, App.retailerID, { from: App.distributorID });
      })
      .then(function (result) {
        $("button[data-id=6]").prop("disabled", true);
        $("button[data-id=7]").prop("disabled", false);
  ...
  receiveItem: function (event) {
    ...
    App.contracts.SupplyChain.deployed()
      .then(function (instance) {
        return instance.receiveItem(App.upc, App.consumerID, { from: App.retailerID });
      })
      .then(function (result) {
        $("button[data-id=7]").prop("disabled", true);
        $("button[data-id=8]").prop("disabled", false);
